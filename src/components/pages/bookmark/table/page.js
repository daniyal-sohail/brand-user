...
const BookmarkTable = ({ bookmarks }) => {
  ...
  const { bookmarkDeleteData, bookmarkLoading } = useBookmark();

  const handleUnbookmark = async (e, templateId) => {
    e.stopPropagation();
  ...
  if (!bookmarks || bookmarks.length === 0) {
    return (
      <div className="text-center text-brand-warm-brown font-poppins py-8">
        ...
        <p className="text-sm mt-2">Start bookmarking templates to see them here!</p>
      </div>
    );
  }
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {bookmarks.map((bookmark) => {
        const template = bookmark.templateId; // Extract template from bookmark structure
          ...
          >
            ...
            {template.thumbnailUrl && (
              <div className="relative mb-4">
                ...
                <div className="absolute top-2 left-2 bg-brand-warm-brown text-brand-cream px-2 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
            ...
            <div className="flex-1">
              ...
              {/* Bookmarked Date */}
              <div className="mb-3">
                <div className="flex items-center gap-1 text-xs text-brand-warm-brown">
                  <Bookmark size={12} />
              ...
              <div className="flex gap-2 mt-auto">
                ...
                <button 
                  ...
                  onClick={(e) => handleUnbookmark(e, template._id)}
